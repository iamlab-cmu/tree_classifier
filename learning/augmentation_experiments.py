...
DATASET_VARIATIONS = [
    ...
    },
    {
        ...
        "do_norm": "false",  # Match the dataset's preprocessing
...
def get_base_config(timestamp, dataset_variation):
    ...
    # Get the base path without 'learning/' prefix
    return {
        # Model configuration - dual audio pretrained model WITHOUT images
        "model.use_images": "False",  # Disabled images
        ...
        "data.do_norm": dataset_variation["do_norm"],  # Set do_norm to match dataset preprocessing
        ...
        "logging.save_misclassified": "false",  # Disable saving misclassified samples
...
def main():
    ...
    # Define augmentation experiments - one for each augmentation type
    augmentation_types = [
    ...
    # Generate all experiments by combining each dataset variation with each augmentation type
    all_experiments = []
